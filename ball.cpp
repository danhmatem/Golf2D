...
void Ball::update(double deltaTime, bool mouseDown, bool mousePressed, vector<Tile> tiles, Hole hole, Mix_Chunk* chargeSfx, Mix_Chunk* swingSfx, Mix_Chunk* holeSfx)
{
    if (win)
    {
